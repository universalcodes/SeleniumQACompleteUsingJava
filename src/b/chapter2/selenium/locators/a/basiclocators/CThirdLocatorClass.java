package b.chapter2.selenium.locators.a.basiclocators;
...
public class CThirdLocatorClass {
    ...
    public static void main(String[] args) {
        ...
        2. There are different types of Locators . id, name, className, linkText cssSelector
        ...
        /*
          //----------------- Positive Case 1 --------------------------
            In the following code, we are going to work with className Locator of given webpage
  ...
  //WebElement validLocatorCheckClassName = openBrowser.findElement(By.name(viewport)); // Compile Time Error name locator is not given in String
        WebElement validLocatorCheckClassName = openBrowser.findElement(By.className("heading"));
       ...
       //  where we can validate weather given Locator is present or not in the webpage
         boolean checkLocatorClassNameValid =validLocatorCheckClassName.isDisplayed();
         System.out.println("Element is Present but Not Visible\t"+checkLocatorClassNameValid);  // The Result is false as given Locator is Present in the webpage but not visible didnt throws the NoSuchElementException as well
       ...
       /* In the following code, we are going to work with className Locator of given webpage
        ...
        //WebElement validLocatorCheckClassName = openBrowser.findElement(By.name(information)); // Compile Time Error name locator is not given in String
        WebElement validLocatorCheckClassName2 = openBrowser.findElement(By.className("information"));

        //    isDisplayed() is the inbuilt method with return type boolean comes under WebElement Interface
        //  where we can validate weather given Locator is present or not in the webpage
        boolean checkLocatorClassNameValid2 =validLocatorCheckClassName2.isDisplayed();
        System.out.println("Element is Present & Visible as well \t"+checkLocatorClassNameValid2);  // The Results returns true as Element is Present & Visible too
        ...
        // In the following line, we're looking for given name Yogesh if given className  locator value is not found in the webpage then
        ...
        WebElement invalidLocatorCheckClassName = openBrowser.findElement(By.name("yogesh"));
        // isDisplayed() is the inbuilt method with return type boolean comes under WebElement Interface
        // where we can validate weather given Locator is present or
        //displayed in the webpage
       // boolean checkLocatorName =invalidLocatorCheckClassName.isDisplayed();
