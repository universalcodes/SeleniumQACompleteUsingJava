...
public class BXpathFunctionContains {
    /*
    Points to Remember
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean checkElement = openBrowser.findElements(By.xpath("//*[contains(text(), 'NOTE')]")).size()>0;
            System.out.println(checkElement);   // Return true if Element is found in the webpage otherwise false
            ...
            WebElement findSameElementUppercaseByTextFunctionUsingHTMLTag = openBrowser.findElement(By.xpath("//*[contains(text(), 'NOTE')]")); // In the Following Code we are tried to find same html text given in Uppercase using text() function using  * means Any T
            ...
            System.out.println("Find the Particular HTML Text with lowercase contains with  text() Function * means Any Tag");
            WebElement findSameElementLowerCaseByTextFunctionUsingHTMLTag = openBrowser.findElement(By.xpath("//*[contains(text(), 'note')]")); // In the Following Code we are tried to find same html text given in lowercase using text() function using  * means Any T
            ...
            System.out.println("Find the Particular HTML Text with toggle contains with using text() Function * means Any Tag");
            WebElement findSameElementToggleByTextFunctionUsingAsterisk = openBrowser.findElement(By.xpath("//*[contains(text(), 'NoTe')]")); // In the Following Code we are tried to find same html text given in togglecase using text() function using  * means Any T
