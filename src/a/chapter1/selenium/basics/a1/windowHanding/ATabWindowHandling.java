package a.chapter1.selenium.basics.a1.windowHanding;
...
public class ATabWindowHandling {
    ...
    4. Key Selenium Methods:
       ...
       Some Notes
        * Always call driver.switchTo().window(handle) before fetching title/URL.
 * switchTo().newWindow(WindowType.TAB/WINDOW) → Selenium 4 feature.
 * executeScript("window.open(...)") → Selenium 3 way to open new tab/window.
 * Close child tabs/windows after operations, then return to parent.
*/
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JavascriptExecutor openNewWindow = ((JavascriptExecutor) openGoogleChrome);
        openNewWindow.executeScript("window.open('https://blinkit.com/','blinkit','width=800,height=600');");
                /*
                            OR
...
*/
        ...
        while (TabHandleIterate.hasNext()) {
            ...
            if (!handleDifferentWindowsTabs.equals(getMainTabHandleID)) {
                ...
                String title = openGoogleChrome.getTitle();
                String url = openGoogleChrome.getCurrentUrl();

                System.out.println("Handle ID: " + handleDifferentWindowsTabs
                        + " | Title: " + title
                        + " | URL: " + url);
